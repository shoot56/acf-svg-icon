...
Plugin URI: https://github.com/shoot56/acf-svg-icon
...
define( 'SWP_ACF_SVG_ICON_VERSION', '1.1.5' );
...
if ( ! class_exists( 'swp_acf_plugin_svg_icon' ) ) {
    ...
    if(!function_exists('acf_sprite_svg')){
        ...
        function acf_sprite_svg($spriteName, $svgWidth = '24', $svgHeight = '24', $return = '' , $file = "/images/icons.svg" ) {
            $svg = get_stylesheet_directory_uri() . $file . '?ver='. filemtime(get_stylesheet_directory() . $file) .'#' . $spriteName;
            $elWidth = '';
            $elHeight = '';
            if (isset($svgWidth)) {
